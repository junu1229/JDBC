...
/*
    ...
    2_1) 제약조건 추가
    PRIMARY KEY : ADD [CONSTARINT 제약조건명] PRIMARY KEY(컬럼명);
    FOREIGN KEY : ADD [CONSTARINT 제약조건명] FOREIGN KEY(컬럼명) REFERECES 테이블명[(컬럼명)];
    UNIQUE : ADD [CONSTARINT 제약조건명] UNIQUE(컬럼명);
    CHECK : ADD [CONSTARINT 제약조건명] CHECK(컬럼에 대한 조건);
...
-- 방법 2. 그냥 부모 테이블만 삭제하는데 제약조건까지 같이 삭제하는 방법
